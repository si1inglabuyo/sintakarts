...
// Handle empty search URL: index.php?search=   → redirect to index.php
...
if (isset($_SESSION['order_success']) && $_SESSION['order_success'] === true) {
    ...
    unset($_SESSION['order_success']); // Clear message after showing once
}
?>
...
<div class="container">
    ...
    <div class="user-profile">
        ...
        ?>
        <div class="flex">
            <a href=""><h2>SintaKart</h2></a>
            <p>Username : <span><?php echo htmlspecialchars($fetch_user['name']); ?></span></p>
            <a href="landing-page.php?logout=<?php echo $user_id; ?>" 
    ...
    <div class="shopping-cart">
        ...
        <table>
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            <td><img src="images/<?php echo htmlspecialchars($fetch_cart['image']); ?>" height="100"></td>
                ...
                <?php
                    ...
                    echo '<tr><td style="padding:20px;" colspan="6">Your cart is empty</td></tr>';
                }
                ?>
            </tbody>
        </table>
        ...
        <div class="cart-btn">
            <?php if ($grand_total > 0): ?>
                <a href="place-order.php" class="btn">Proceed to Checkout</a>
            <?php else: ?>
                <p class="empty-cart-message">Looks like it’s shopping time! 🛒</p>
            <?php endif; ?>
        </div>
    </div>
